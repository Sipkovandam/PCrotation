...
//																	writeFolder));
//
//			foldersToCombine.addAll(createMaxCountFiles(	patientSampleNameToFamilyId,
//															parentSampleNameToFamilyId,
//															sampleNameToFamilySampleNames,
//															writeFolder,
//															maxBiosRawCountTracker,spliceToMedianBios));
//			
...
//	}
//
//	private ArrayList<String> createMaxCountFiles(HashMap<String, String> patientSampleNameToFamilyId,
//																HashMap<String, String> parentSampleNameToFamilyId,
//																HashMap<String, HashMap<String, Integer>> sampleNameToFamilySampleNames,
//																String rootFolder,
//																HashMap<String, Double> maxBiosRawCountTracker,
//																HashMap<String, String> spliceToMedianBios)
//	{
//		String writeFolder = rootFolder + FileUtils.removeExtention(new File(this.rawMatrixFn).getName());
//
//		ArrayList<String> foldersMaxCountRaw = new ArrayList<String>();
//		String maxReadCountOtherCasesFolder = writeFolder + "maxReadCountOtherCases/Bios/";
//		String maxReadCountOtherParentFolder = writeFolder + "maxReadCountOtherParent/Bios/";
//		foldersMaxCountRaw.add(maxReadCountOtherCasesFolder);
//		foldersMaxCountRaw.add(maxReadCountOtherParentFolder);
//		
//		if (rawMatrixFn == null)
//		{
//			p("Warning rawMatrixFn = null, skipping");
//			return null;
//		}
//
...
//		executeSubSteps(this.rawMatrixFn,
//						biosIndexes,
//						studyIndexes,
//						"Bios",
...
//									String casesOutlierFolder,
//									HashMap<String, Double> maxBiosRawCount,
//									HashMap<String, String> biosMedian, boolean countOutliers) throws FileNotFoundException, IOException
//	{
//		BufferedReader sampleReader = FileUtils.createReader(matrixFn);
...
//															this.zScoreCutoff);
//					else
//						outlierCountOtherCases = compareAndSetReadMaxCount(	maxReadCountOtherCases,
//																		row.rowName,
//																		sampleName,
//																		(int) row.values[c],
//																		patientSampleNameToFamilyId,
