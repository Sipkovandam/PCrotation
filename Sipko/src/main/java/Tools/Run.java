...
public class Run 
{
	...
	static void run(String[] args) throws Exception 
	{
		...
		//args = new String[]{"getjson","STAR.SpliceMerger","E:/Groningen/Test/JSON/"};
	...
	public static void executeScript(String jsonFN) throws Exception 
	{
		...
		Method readVars = runClass.getMethod("readVars", String.class,runClass.getClass());
		
		Script<?> runObject = (Script<?>) readVars.invoke(objectLoader,jsonFN,runClass);
		
		Method startMethod = runClass.getMethod("start");
	...
	public static void createConfigFile(String[] args) throws Exception 
	{
		...
		//get the method
		Method writeConfig = configClass.getMethod("createConfig", String.class);
		//invoke the method
		writeConfig.invoke(configWriter, file.getAbsolutePath());
	}
}
