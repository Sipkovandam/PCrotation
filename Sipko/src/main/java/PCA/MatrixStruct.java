...
//		}
	...
	public void addRandomValues(double cutoff, Var var) throws IOException //adds cutoff*random() to all values <cutoff
	{
		if(cutoff <= 0)
		 return;
		...
		if(var != null)
			write(var.writeFolder+"randAddedToBelow_" +var.randomValue + ".txt.gz");
	}
