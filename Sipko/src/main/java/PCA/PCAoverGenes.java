...
{
	//tried to refactor code at some point but never finished because there is to much other stuff to do...
	public static void main(String[] args) throws IOException, NotConvergedException
	{
		...
		expressionMatrixStruct.addRandomValues(randomAddValue, null);
