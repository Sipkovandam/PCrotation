...
public class RLog 
{
	...
	public static void rLog(MatrixStruct expressionStruct, String writeFolder, String fileName, String writeGeoFN) throws IOException 
	{
		rLog(expressionStruct, writeFolder, fileName, null, writeGeoFN);
	}
	
	private static MatrixStruct getGeoMeans(MatrixStruct expressionStruct, String writeFolder, String writeGeoFN) throws IOException {
		...
		MatrixStruct geoMean = new MatrixStruct(expressionStruct.rows(),1);
		...
		MatrixStruct keepGenes = new MatrixStruct(expressionStruct.rows(),1);
	...
	public static void rLog(MatrixStruct expressionStruct, String writeFolder, String fileName, MatrixStruct geoMean, String writeGeoFN) throws IOException 
	{
		if(geoMean == null)
		{
		...
		MatrixStruct denominators = getDenominators(expressionStruct, fileName, geoMean, writeFolder);
	...
	private static MatrixStruct getDenominators(MatrixStruct expressionStruct, String fileName, MatrixStruct geoMean, String writeFolder) throws IOException {
		...
		MatrixStruct denominators = new MatrixStruct(expressionStruct.cols(),1);
