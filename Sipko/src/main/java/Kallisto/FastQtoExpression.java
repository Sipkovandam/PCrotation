...
public class FastQtoExpression {
	...
	private static void combineKallistoOutput() throws Exception {
		...
		CombineKallisto.main(new String[] { "kallistoOutputFolder=" + var.kallistoOutputRoot,
				"kallistoColumn=" + var.kallistoOutputColumn, "transcriptsToGenesFN=" + var.transcriptsToGenesFN,
				"threshold=" + var.kallistoThreshold,
				"minpercentagefeaturesexpressed=" + var.minpercentagefeaturesexpressed,
				"mappingpercentagesfn=" + mappingPercentagesFN, "tsvthatshouldbetherefn=" + tsvFilesToShScriptFN });
	}

	private static void kallistoSlurm(String fastQFiles) throws Exception {
		new Slurm().run(new String[] { "fastQFiles=" + fastQFiles, "kallistoIndexFile=" + var.kallistoIndexFile,
				"writefolder=" + var.kallistoOutputRoot, "kallistoVersion=" + var.kallistoVersion,
				"kallistoThreads=" + var.kallistoThreads, "kallistoWalltime=" + var.kallistoWalltime,
				"kallistoMaxMemory=" + var.kallistoMaxMemory, "pairStrings=" + var.pairStrings,
				"slurmUserName=" + var.slurmUserName, "finishedemailaddress=" + var.finishedemailaddress });

	}

	private static String findFastQFiles() throws Exception {
		String fastQFiles = var.outputFolder + "fastQfiles.txt";
		FileSearcher.main(new String[] { "foldername=" + var.inputFolder, "writefn=" + fastQFiles,
				"searchstrings=" + var.fastQSearchStrings, "forbiddenstrings=" + var.forbiddenSearchStrings });
		return fastQFiles;
	}
